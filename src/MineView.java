...
class MineView
{
  ...
  private class ControlPanel extends JPanel
  {
    ...
    ControlPanel() 
    {
      ...
      add(newGameButton);
      rowsField = new JTextField(defaultNumRows+"", 3);
      colsField = new JTextField(defaultNumCols+"", 3);
      minesField = new JTextField(defaultNumMines+"", 3);
      add(new JLabel("Rows: "));
      add(rowsField);
      add(new JLabel("Cols: "));
      add(colsField);
  ...
  private class GamePanel extends JPanel
  {
    ...
    {   
      ...
      if (cell.isFlagged()) 
      {
        ...
        pen.setColor(new Color (227,227,227));
        ...
        pen.setColor(new Color(211, 35, 31));
      ...
      else 
      {
        ...
        if (debug && !cell.isVisible())
          ...
          switch(cell.getNeighborMines()){
            case 1:
              pen.setColor(new Color(104, 169, 255));
              break;
            case 2:
              pen.setColor(new Color(56, 192, 54));
              break;
            case 3:
              pen.setColor(new Color(228, 70, 45));
              break;
            case 4:
              pen.setColor(new Color(70, 28, 148));
              break;
            case 5:
              pen.setColor(new Color(116, 4, 68));
              break;
            case 6:
              pen.setColor(new Color(18, 153, 125));
              break;
            case 7:
              pen.setColor(new Color(0, 0, 0));
              break;
            case 8:
              pen.setColor(new Color(84, 84, 84));
              break;
